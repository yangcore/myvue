<template>
	<div class="myStrategy">
		...
		<el-row class='myStrategy-list' v-for='(iteam,index) in myStrategyList' :key="iteam.id">
			<el-col :span="8">{{iteam.name}}</el-col>
			<el-col :span="8">{{iteam.money}}</el-col>
			<el-col :span="8">编辑策略 &nbsp;&nbsp;
				<i class="el-icon-arrow-up" @click="up(index)"></i> &nbsp;&nbsp;&nbsp;&nbsp;
				<i class="el-icon-arrow-down" @click='down(index)'></i> &nbsp;&nbsp;
				<el-switch v-model="iteam.value2" on-color="#13ce66" off-color="#ff4949" :change='openORclose(iteam.value2)'>
				</el-switch>
			</el-col>
		</el-row>
